...
(defvar zenburn-default-colors-alist
  '(("zenburn-fg+1"     . "#FFFFEF")
    ...
    ("zenburn-orange"   . "#DFAF87")
    ("zenburn-yellow"   . "#F0DFAF")
    ("zenburn-yellow-1" . "#E0CF9F")
    ("zenburn-yellow-2" . "#D0BF8F")
    ("zenburn-green-1"  . "#5F7F5F")
    ("zenburn-green"    . "#87AF5F")
...
;;;;; isearch
   ...
   `(mode-line-inactive
     ((t (:foreground ,zenburn-green-1
                      ...
                      :box (:line-width -1 :style released-button)))))
   `(region ((,class (:background ,zenburn-fg-1))
             (t :inverse-video t)))
...
;;;;; font lock
   `(font-lock-builtin-face ((t (:foreground ,zenburn-magenta))))
   `(font-lock-comment-face ((t (:foreground ,zenburn-fg-1))))
   `(font-lock-comment-delimiter-face ((t (:foreground ,zenburn-fg-1))))
   `(font-lock-constant-face ((t (:foreground ,zenburn-magenta))))
   `(font-lock-doc-face ((t (:foreground ,zenburn-green))))
   `(font-lock-function-name-face ((t (:foreground ,zenburn-orange))))
   `(font-lock-keyword-face ((t (:foreground ,zenburn-red))))
...
;;;;; git-gutter
   ...
   `(git-gutter:modified ((t (:foreground ,zenburn-magenta :weight bold))))
   `(git-gutter:unchanged ((t (:foreground ,zenburn-fg :weight bold))))
;;;;; git-gutter-fr
...
;;;;; linum-mode
   `(linum ((t (:foreground ,zenburn-fg-1 :background ,zenburn-bg))))
;;;;; lispy
...
;;;;; mew
   ...
   `(mew-face-header-al ((t (:foreground ,zenburn-fg :weight bold))))
